...
monkeyc -f monkey.jungle -d edge1050 -o bin/CBREdgeDash.prg -y ./developer_key.der
...
if [ $? -eq 0 ]; then
    ...
    echo "🎮 Ejecutando aplicación en Edge 1050"
    monkeydo bin/CBREdgeDash.prg edge1050
